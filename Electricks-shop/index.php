...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
               <br> <a href="./project/index.html/index.html" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom" target="">
                 <h2 class="h22"><b> Visit Pet World!</b></h2> 
				 <style>
				 .h22{
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="green">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/s2.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="./assets/img/logo.jpeg" height="100" alt="Circle Image" class="rounded-circle">
                        <br><br>
						<div class="headd">
						
                        <h1><b>Welcome to pet World shopping site!<b></h1>
						</div>
						<style>
						.headd{
							color:white;
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>
							<b>
                            “The reason it seems that price is all your customers care about is that you haven’t given them anything else to care about.”<br/>-Seth Godin</b>
                            </p>
                        </div>
                        <br>
