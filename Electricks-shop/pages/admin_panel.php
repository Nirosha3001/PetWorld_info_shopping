...
<body class="profile-page sidebar-collapse">
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/s2.jpg');"></div>
                <div class="container">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    ...
                    <a href="https://www.twitter.com"  <target="new"> <img src="../assets/img/tw.png" height="45"> <class="btn btn-default btn-round btn-lg btn-icon"> <rel="tooltip"> <title="Follow me on Twitter">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="https://www.instagram.com" <target="new"><img src="../assets/img/facebook.png" height="45"> <class="btn btn-default btn-round btn-lg btn-icon"> <rel="tooltip"> <title="Follow me on Instagram">
                        <i class="fa fa-instagram"></i>
                    </a>
                </div>
               <div class="row">
