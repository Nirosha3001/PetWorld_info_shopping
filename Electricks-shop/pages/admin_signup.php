...
?>
    ...
    <div class="page-header" filter-color="blue">
        <div class="page-header-image" style="background-image:url(../assets/img/s2.jpg)"></div>
        <div class="container">
                    ...
                    <form class="form" method="post" action="">
                        <div class="header header-primary text-center">
                            <div class="logo-container">
                                <!--**LOGO**-->
								<img src="../assets/img/logo.jpeg" height="80"  alt="Circle Image" class="rounded-circle">
                                <!--insert logo here-->
                            </div>
                        </div>
                        <div class="content">
