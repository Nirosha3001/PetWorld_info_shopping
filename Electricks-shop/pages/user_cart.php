              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Manila City">bangalore</option>
                      <option value="Caloocan City">Mysore</option>
                      <option value="Las Pinas City">Hassan</option>
                      <option value="Makati City">Mangalore</option>
                      <option value="Malabon City">belgaum</option>
                      <option value="Mandaluyong City">Hubli</option>
                      <option value="Marikina City">Honnavar</option>
                      <option value="Muntinlupa City">Udupi</option>
                      <option value="Navotas City">Shivamogga</option>
                      <option value="Paranaque City">Gurbarga</option>
                      <option value="Pasay City">Vijayapura</option>
                      <option value="Pasig City">Ballari</option>
                      <option value="Quezon City">Tumkur</option>
                      <option value="San Juan City">Bidar</option>
                      <option value="Taguig City">Dharwad</option>
                      <option value="Valenzuela City">Raichur</option>
                      </select>  
                      </div>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Pet World, Inc.
                </div>
            </div>
        </footer>
    </div>
